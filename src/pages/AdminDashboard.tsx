  ...
  return (
    <AdminLayout>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <div className="bg-white dark:bg-gray-900 p-6 rounded-lg shadow flex flex-col items-start">
          <span className="text-sm text-muted-foreground mb-1">ROI</span>
          <div className="text-2xl font-bold mb-1">{roi.toFixed(2)}%</div>
        ...
        <div className="bg-white dark:bg-gray-900 p-6 rounded-lg shadow flex flex-col items-start">
          ...
          <div className="text-2xl font-bold mb-1">{customerReturnRate.toFixed(1)}%</div>
        ...
        <div className="bg-white dark:bg-gray-900 p-6 rounded-lg shadow flex flex-col items-start">
          ...
          <div className="text-2xl font-bold mb-1">{conversionRate.toFixed(1)}%</div>
        ...
        <div className="bg-white dark:bg-gray-900 p-6 rounded-lg shadow flex flex-col items-start">
          ...
          <div className="text-2xl font-bold mb-1">{inventoryTurnover.toFixed(2)}</div>
        ...
        <div className="bg-white dark:bg-gray-900 p-6 rounded-lg shadow flex flex-col items-start">
          ...
          <div className="text-2xl font-bold mb-1">${averageOrderValue.toLocaleString(undefined, { maximumFractionDigits: 0 })}</div>
        ...
        <div className="bg-white dark:bg-gray-900 p-6 rounded-lg shadow flex flex-col items-start">
          ...
          <div className="text-lg font-bold mb-1">{bestSellingProduct ? bestSellingProduct.name : '-'}</div>
        ...
        <div className="flex flex-row gap-6">
          {monthlySales.map(ms => (
            <div key={ms.month} className="flex flex-col items-center">
              ...
              <div className="h-16 w-8 bg-luxe-gold rounded-t flex items-end justify-center" style={{ height: `${ms.total/500}px` }}>
